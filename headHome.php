...
// You don't need to select the database here because it's done in the connection itself
...
<div>
    <form style="margin-top: 10%; margin-left: 40%;" method="post">
        <div > <!-- Added a div for margin spacing -->
...
<div style="position: fixed; left: 0; bottom: 0; width: 100%; background-color: rgba(0,0,0,0.5); color: white; text-align: center;">
