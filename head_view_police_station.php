...
<head>
    ...
    // Create a connection
    $conn = mysqli_connect("localhost", "root", "", "crime_portal"); // Pass the database name here
    ...
    // No need to select the database again because it's included in the connection
    $query = "SELECT i_id, i_name, location FROM police_station";
    $result = mysqli_query($conn, $query);  // Fix the order of parameters
    ...
    <div style="padding: 50px;">
        <table class="table table-bordered">
            ...
            <tbody style="background-color: white; color: black;">
                ...
                ?>
                    <tr>
                        <td><?php echo htmlspecialchars($rows['i_id']); ?></td>
                        <td><?php echo htmlspecialchars($rows['i_name']); ?></td>
